...
data_path = '/data/nli-consistency/vqa/lxmert-run-train-10000im-3pred-40token-1seed_predictions_nli.json'

models = ["ynie/albert-xxlarge-v2-snli_mnli_fever_anli_R1_R2_R3-nli",
              "roberta-large-mnli"]
save_paths = ['/data/nli-consistency/vqa/lxmert-run-train-10000im-3pred-40token-1seed_predictions_nli-xxlarge.json',
              '/data/nli-consistency/vqa/lxmert-run-train-10000im-3pred-40token-1seed_predictions_nli-mnli.json']
