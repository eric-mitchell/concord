...
data_path = '/u/scr/nlp/data/nli-consistency/vilt_results/vilt-test-3pred-40token-1seed_predictions.json'

with open(data_path, 'r') as f:
    data = json.load(f)
    
save_path = '/u/scr/nlp/data/nli-consistency/vilt_results/vilt-test-3pred-40token-1seed_predictions_nli.json'
